<template>
    <div class="flex flex-col flex-1 items-center ">
        ...
        <div class="flex flex-col items-center text-white py-12">
            ...
            <img class="w-[150px] h-auto bg-slate-400" :src="
        ...
        <!-- Hourly Weather -->
        <div class="max-w-screen-md w-full py-12 backdrop-blur-">
            <div class="mx-8 text-white">
                ...
                <div class="flex gap-10 overflow-x-scroll" >
                    ...
                    <img
                        class="w-auto h-[50px] object-cover bg-slate-400"
                        :src="
        ...
        <div class="max-w-screen-md w-full py-12">
            ...
            >
                ...
                <img
                class="w-[50px] h-[50px] object-cover bg-slate-400"
                :src="
